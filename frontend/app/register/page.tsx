...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen px-5 py-10"><div className="mx-auto w-full max-w-xl animate-in">
      <div className="flex items-center justify-between"><Link href="/" className="flex h-11 w-11 items-center justify-center rounded-full bg-white text-xl font-black text-black">P</Link><Link href="/login" className="rounded-full border border-[#536471] px-5 py-2 text-sm font-bold hover:bg-[#181818]">Войти</Link></div>
      <p className="mt-12 text-sm font-bold text-[#1d9bf0]">Новый аккаунт</p><h1 className="mt-2 text-4xl font-extrabold">Присоединиться к Pulse</h1><p className="mt-3 text-[#71767b]">Пара минут — и можно публиковать.</p>
